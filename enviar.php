...
$email_envio = 'contato@delfosim.com'; // E-mail receptor
$email_pass = ''; // Senha do e-mail

$site_name = 'Delfos IM'; // Nome do Site
$site_url = 'delfosim.com'; // URL do Site

$host_smtp = 'smtp.hostgator.com'; // HOST SMTP Ex: smtp.domain.com.br
